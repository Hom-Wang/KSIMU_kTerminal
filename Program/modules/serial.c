...
UART_InitTypeDef hserial =
{
    ...
    .PinTXD              = NRF_GPIO_PIN_MAP(0, SERIAL_TXD_PIN),
    .PinRXD              = NRF_GPIO_PIN_MAP(0, SERIAL_RXD_PIN),
    .PinRTS              = NRF_GPIO_PIN_MAP(0, SERIAL_RTS_PIN),
    .PinCTS              = NRF_GPIO_PIN_MAP(0, SERIAL_CTS_PIN),
